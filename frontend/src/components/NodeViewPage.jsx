                        ...
                        <div className="column">
                            ...
                            {!node.IsPassive && <>
                                ...
                                <div className="block">
                                    ...
                                    {node.Parent != null ? <Link to={`/nodes/view/${node.Parent.ID}`}><p>{node.Parent.Name} ({`${node.Parent.Address.street.type.short_name} ${node.Parent.Address.street.name}, ${node.Parent.Address.house.type.short_name} ${node.Parent.Address.house.name}`})</p></Link> : <p>-</p>}
                                </div>
                            </>}
                            <div className="block">
